...
extension ExpenseQueryWhere on QueryBuilder<Expense, Expense, QWhereClause> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> idGreaterThan(Id id, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> idLessThan(Id id, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension ExpenseQueryFilter on QueryBuilder<Expense, Expense, QFilterCondition> {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> dateEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'date',
        value: value,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> nameContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> nameMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryObject on QueryBuilder<Expense, Expense, QFilterCondition> {}

extension ExpenseQueryLinks on QueryBuilder<Expense, Expense, QFilterCondition> {}
...
extension ExpenseQuerySortThenBy on QueryBuilder<Expense, Expense, QSortThenBy> {
...
extension ExpenseQueryWhereDistinct on QueryBuilder<Expense, Expense, QDistinct> {
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByName({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty on QueryBuilder<Expense, Expense, QQueryProperty> {
